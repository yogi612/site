...
export default function AdminDashboard() {
  ...
  const loanData = [
    { name: "Jan", pending: 40, approved: 24, rejected: 10 },
    { name: "Feb", pending: 30, approved: 13, rejected: 20 },
    { name: "Mar", pending: 20, approved: 98, rejected: 15 },
    { name: "Apr", pending: 27, approved: 39, rejected: 25 },
    { name: "May", pending: 18, approved: 48, rejected: 12 },
    { name: "Jun", pending: 23, approved: 38, rejected: 18 },
  ]
          ...
          >
            <Card>
              <CardHeader>
                ...
                <CardDescription>Distribution of loan applications by type</CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={350}>
                  <PieChart>
