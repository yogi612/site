      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-lg border bg-card p-6 shadow-sm">
          ...
          <p className="text-muted-foreground">
            This is your personal dashboard where you can manage your financial services.
          </p>
        </div>

        <div className="rounded-lg border bg-card p-6 shadow-sm">
          <h2 className="mb-4 text-xl font-semibold">Loan Applications</h2>
          <p className="text-muted-foreground">You have no active loan applications.</p>
          <button className="mt-4 rounded-md bg-primary px-4 py-2 text-white">Apply for a Loan</button>
        </div>
